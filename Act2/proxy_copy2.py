...
# copy_sock() corre en ambos threads, uno de conn->conn2 y otro de conn2->conn
    ...
    newthread1 = threading.Thread(target=copy_sock, daemon=True, args=(conn,conn2)) # el flag daemon es para que muera si muere el otro 
    newthread1.start()
