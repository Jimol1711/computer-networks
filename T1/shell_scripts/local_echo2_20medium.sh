...
time { for i in $(seq 1 20); do
  ../client_bw.py 1000 localhost 1818 < ./medium_files/file${i}.bin > ./trash/OUT20_${i}_1000 &
done }
wait
echo "Twenty medium files in parallel for echo2 port 1818 size 2000:"
time { for i in $(seq 1 20); do
  ../client_bw.py 2000 localhost 1818 < ./medium_files/file${i}.bin > ./trash/OUT20_${i}_2000 &
done }
wait
...
time { for i in $(seq 1 20); do
  ../client_bw.py 8000 localhost 1818 < ./medium_files/file${i}.bin > ./trash/OUT20_${i}_8000 &
done }
wait